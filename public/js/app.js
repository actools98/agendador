document.addEventListener('DOMContentLoaded', function() {
  ...
  // ========== ENFOQUE EN FRANJA LABORAL (VERSIÓN ROBUSTA) ==========
  function focusWorkHours() {
    ...
    setTimeout(() => {
      ...
      if (!container) {
        console.warn('⚠️ Contenedor no encontrado para enfocar');
        return;
      }
      ...
      // Calcular la posición del objetivo dentro del contenedor
